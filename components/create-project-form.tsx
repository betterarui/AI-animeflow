...
export function CreateProjectForm() {
  ...
  return (
    <main className="cinematic-app-page create-cinematic-page min-h-screen px-6 py-6">
      ...
      <section className="create-cinematic-card mx-auto mt-8 max-w-5xl overflow-hidden rounded-card border border-line bg-white shadow-work">
